    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 mb-4">
          All our plans work great for businesses of any size! Just pick the one
          that fits your needs best, and select the number of users to see the
          corresponding price.
        </p>
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6 text-center">
          ...
          <p className="text-gray-600 mb-4">
            Need a plan tailored to your business? Contact us to customize user
            limits, features, and pricing to fit your needs.
          </p>
